...
<div class="container">
	...
	<form action="APISecurePay" class="form-horizontal" method="POST">
		<br />
		<h4>Hantepay URL Settings</h4>
		<div class="form-group">
			<label for="url" class="col-sm-2 control-label">API URL*</label>
			<div class="col-sm-10">
				<select name="url" id="url" class="form-control" required>
					<option value='https://api.hantepay.cn/v1.3/transactions/securepay'>HantePay Live API UeRL</option>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="token" id="token" value="123456" required>
			</div>
		</div>
